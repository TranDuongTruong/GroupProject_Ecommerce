...
namespace GroupProject_Ecommerce.Scripts
{
    public class DBContext
    {
        ...
        {
            // string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\admin\OneDrive\Tài liệu\hoangquyen\GroupProject_Ecommerce\GroupProject_Ecommerce\App_Data\Database.mdf;Integrated Security=True";
